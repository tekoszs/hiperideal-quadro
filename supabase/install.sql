...
-- INSTALAÇÃO COMPLETA — GERADO AUTOMATICAMENTE, não editar à mão.
-- Regerar: bash scripts/build_schema.sh
--
-- Cole este arquivo INTEIRO no SQL Editor do Supabase e execute uma vez.
-- Contém: estrutura (migrations 0001..0018) + catálogo da planilha.
--
-- NÃO rode supabase/local/00_auth_shim.sql no Supabase: o schema auth
-- já existe lá. O shim é só para PostgreSQL local.
--
-- Depois de executar, rode supabase/tests/schema_checks.sql para conferir.
-- ============================================================================
...
-- ===========================================================================
-- seed.sql — catálogo gerado de docs/Quadrodia.xlsx
-- ===========================================================================
...
-- ===========================================================================
-- 0017_seed_network_staffing.sql — REEXECUÇÃO após o seed
--
-- Repetida de propósito: na ordem das migrations o catálogo de funções
-- ainda não existia. É idempotente — ver o cabeçalho do arquivo.
-- ===========================================================================
-- ===========================================================================
-- 0017 -- FUNCOES DISPONIVEIS EM TODAS AS LOJAS DA REDE
-- ===========================================================================
